...
import com.rocketseat.certification_nlw.modules.questions.dtos.AlternativesResultDTO;
import com.rocketseat.certification_nlw.modules.questions.dtos.QuestionResultDTO;
...
public class QuestionController {
  ...
  public List<QuestionResultDTO> findByTechnology(@PathVariable String technology) {
    ...
    var query = this.questionRepository.findByTechnology(technology);

    var toMap = query.stream().map(question -> mapQuestionToDTO(question))
